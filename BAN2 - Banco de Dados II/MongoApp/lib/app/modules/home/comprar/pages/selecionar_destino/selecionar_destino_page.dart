...
import 'selecionar_destino_controller.dart';

class SelecionarDestinoPage extends StatefulWidget {
  final String title;
  const SelecionarDestinoPage({Key key, this.title = "Selecionar Destino"})
      : super(key: key);
...
class _SelecionarDestinoPageState
    extends ModularState<SelecionarDestinoPage, SelecionarDestinoController> {
